...
class ThinkRequest(BaseModel):
    ...
    """ # noqa: E501
    query: StrictStr
    thinking_budget: Optional[StrictInt] = 50
    context: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["query", "thinking_budget", "context"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "query": obj.get("query"),
            "thinking_budget": obj.get("thinking_budget") if obj.get("thinking_budget") is not None else 50,
