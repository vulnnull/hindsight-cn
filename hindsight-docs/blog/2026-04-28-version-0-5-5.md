...
## Breaking change: bank profile no longer auto‑creates banks {#breaking-change-bank-profile-no-longer-auto-creates-banks}
...
## Mental Models — List view {#mental-models-list-view}
