...
| `retainContext`         | `conversation between the user and you (the coding agent): user turns are the user's words and decisions, assistant turns are yours` | the `context` sent with every session write-back. Extraction reads it to decide whose claim a sentence is, so the default names both speakers. Accepts the same `{placeholder}` templates as `retainTags`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
