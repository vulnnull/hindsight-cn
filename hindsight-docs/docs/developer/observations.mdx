...
import observationsPy from '!!raw-loader!@site/examples/api/observations.py';
import {Flow} from '@vectorize-io/interfig';
import observationsFigure from '@vectorize-io/interfig/figures/observations';
...
<CodeSnippet code={observationsPy} section="targeted-consolidation" language="python" />
...
<CodeSnippet code={observationsPy} section="clear-observations" language="python" />
