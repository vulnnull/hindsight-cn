...
- **A change takes a few seconds to reach every API replica.** See [`HINDSIGHT_API_BANK_ALIAS_CACHE_TTL_SECONDS`](/developer/configuration#bank-alias-cache).
...
<TabItem value="node" label="Node.js">
<CodeSnippet code={memoryBanksMjs} section="transfer-import-external" language="javascript" />
</TabItem>
<TabItem value="cli" label="CLI">
