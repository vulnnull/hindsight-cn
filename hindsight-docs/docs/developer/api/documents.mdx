...
import documentsSh from '!!raw-loader!@site/examples/api/documents.sh';
...
<CodeSnippet code={documentsSh} section="document-retain" language="bash" />
</TabItem>
...
<TabItem value="cli" label="CLI">
<CodeSnippet code={documentsSh} section="document-update" language="bash" />
</TabItem>
<TabItem value="go" label="Go">
...
<TabItem value="cli" label="CLI">
<CodeSnippet code={documentsSh} section="document-get" language="bash" />
</TabItem>
<TabItem value="go" label="Go">
...
<TabItem value="cli" label="CLI">
<CodeSnippet code={documentsSh} section="document-update-tags" language="bash" />
</TabItem>
<TabItem value="go" label="Go">
<CodeSnippet code={documentsGo} section="document-update-tags" language="go" />
</TabItem>
</Tabs>
...
<TabItem value="cli" label="CLI">
<CodeSnippet code={documentsSh} section="document-delete" language="bash" />
</TabItem>
<TabItem value="go" label="Go">
...
<TabItem value="cli" label="CLI">
<CodeSnippet code={documentsSh} section="document-list" language="bash" />
</TabItem>
<TabItem value="go" label="Go">
