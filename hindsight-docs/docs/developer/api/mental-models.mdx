...
import refreshModes from '@vectorize-io/interfig/figures/refresh-modes';
...
<Tabs>
<TabItem value="python" label="Python">
<CodeSnippet code={mentalModelsPy} section="mental-model-detail" language="python" />
</TabItem>
<TabItem value="node" label="Node.js">
<CodeSnippet code={mentalModelsMjs} section="mental-model-detail" language="javascript" />
</TabItem>
<TabItem value="cli" label="CLI">
<CodeSnippet code={mentalModelsSh} section="mental-model-detail" language="bash" />
</TabItem>
<TabItem value="go" label="Go">
<CodeSnippet code={mentalModelsGo} section="mental-model-detail" language="go" />
</TabItem>
</Tabs>
...
<Tabs>
<TabItem value="python" label="Python">
<CodeSnippet code={mentalModelsPy} section="dry-run-refresh" language="python" />
</TabItem>
<TabItem value="node" label="Node.js">
<CodeSnippet code={mentalModelsMjs} section="dry-run-refresh" language="javascript" />
</TabItem>
<TabItem value="cli" label="CLI">
<CodeSnippet code={mentalModelsSh} section="dry-run-refresh" language="bash" />
</TabItem>
<TabItem value="go" label="Go">
<CodeSnippet code={mentalModelsGo} section="dry-run-refresh" language="go" />
</TabItem>
</Tabs>
...
<Tabs>
<TabItem value="python" label="Python">
<CodeSnippet code={mentalModelsPy} section="keep-trace" language="python" />
</TabItem>
<TabItem value="node" label="Node.js">
<CodeSnippet code={mentalModelsMjs} section="keep-trace" language="javascript" />
</TabItem>
<TabItem value="cli" label="CLI">
<CodeSnippet code={mentalModelsSh} section="keep-trace" language="bash" />
</TabItem>
<TabItem value="go" label="Go">
<CodeSnippet code={mentalModelsGo} section="keep-trace" language="go" />
</TabItem>
</Tabs>
