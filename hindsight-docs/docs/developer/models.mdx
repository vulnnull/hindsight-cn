...
This is the opposite direction from the [Cursor integration](/sdks/integrations/cursor),
...
recall returns. See [Configuration](/developer/configuration#typesafe) for the full
