...
class MemoraInterceptor:
    ...
    def __init__(self):
        ...
        self._client: Optional[Memora] = None

    def get_client(self, config: MemoraConfig) -> Memora:
        """Get or create the Memora client."""
        if self._client is None:
            self._client = Memora(base_url=config.memora_api_url, timeout=30.0)
        return self._client
    ...
    async def store_conversation(
        ...
        """
        Store conversation in Memora after receiving response from OpenAI.
        """
    ...
    async def process_response(
        ...
        **kwargs: Any,
        ...
        Stores the conversation in Memora.
        """
        config = get_config()
