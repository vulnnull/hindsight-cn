...
func (o *MemoryItem) GetResolveEntities() bool {
...
// and a boolean to check if the value has been set.
func (o *MemoryItem) GetResolveEntitiesOk() (*bool, bool) {
	if o == nil || IsNil(o.ResolveEntities) {
		return nil, false
	}
...
func (o *MemoryItem) HasResolveEntities() bool {
	if o != nil && !IsNil(o.ResolveEntities) {
		return true
	}
...
func (o *MemoryItem) SetResolveEntities(v bool) {
	o.ResolveEntities = &v
}
