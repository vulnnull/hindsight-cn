...
type ApiCreateBankAliasRequest struct {
	ctx context.Context
	ApiService *BanksAPIService
	bankId string
	createBankAliasRequest *CreateBankAliasRequest
	authorization *string
}

func (r ApiCreateBankAliasRequest) CreateBankAliasRequest(createBankAliasRequest CreateBankAliasRequest) ApiCreateBankAliasRequest {
	r.createBankAliasRequest = &createBankAliasRequest
	return r
}

func (r ApiCreateBankAliasRequest) Authorization(authorization string) ApiCreateBankAliasRequest {
	r.authorization = &authorization
	return r
}

func (r ApiCreateBankAliasRequest) Execute() (*BankAliasesResponse, *http.Response, error) {
	return r.ApiService.CreateBankAliasExecute(r)
}

/*
CreateBankAlias Add an alias to the bank
...
Returns 409 if the name is already a bank or another alias.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param bankId
 @return ApiCreateBankAliasRequest
*/
func (a *BanksAPIService) CreateBankAlias(ctx context.Context, bankId string) ApiCreateBankAliasRequest {
	return ApiCreateBankAliasRequest{
		ApiService: a,
		ctx: ctx,
		bankId: bankId,
...
func (a *BanksAPIService) CreateBankAliasExecute(r ApiCreateBankAliasRequest) (*BankAliasesResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "BanksAPIService.CreateBankAlias")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v1/default/banks/{bank_id}/aliases"
	localVarPath = strings.Replace(localVarPath, "{"+"bank_id"+"}", url.PathEscape(parameterValueToString(r.bankId, "bankId")), -1)

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.createBankAliasRequest == nil {
		return localVarReturnValue, nil, reportError("createBankAliasRequest is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.createBankAliasRequest
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
...
type ApiDeleteBankAliasRequest struct {
	ctx context.Context
	ApiService *BanksAPIService
	bankId string
	alias string
...
func (r ApiDeleteBankAliasRequest) Authorization(authorization string) ApiDeleteBankAliasRequest {
	r.authorization = &authorization
	return r
}

func (r ApiDeleteBankAliasRequest) Execute() (*BankAliasesResponse, *http.Response, error) {
	return r.ApiService.DeleteBankAliasExecute(r)
}

/*
DeleteBankAlias Remove an alias from the bank
...
Stop an id reaching this bank. The bank and its memories are untouched; only the extra name goes away, and callers still using it get the same 404 (or new empty bank) they would have got before it existed.
 ...
 @param bankId
 @param alias
 @return ApiDeleteBankAliasRequest
*/
func (a *BanksAPIService) DeleteBankAlias(ctx context.Context, bankId string, alias string) ApiDeleteBankAliasRequest {
	return ApiDeleteBankAliasRequest{
		ApiService: a,
		ctx: ctx,
		bankId: bankId,
...
// Execute executes the request
//  @return BankAliasesResponse
func (a *BanksAPIService) DeleteBankAliasExecute(r ApiDeleteBankAliasRequest) (*BankAliasesResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodDelete
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "BanksAPIService.DeleteBankAlias")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiListBankAliasesRequest struct {
	ctx context.Context
	ApiService *BanksAPIService
	bankId string
	authorization *string
...
func (r ApiListBankAliasesRequest) Authorization(authorization string) ApiListBankAliasesRequest {
	r.authorization = &authorization
	return r
}

func (r ApiListBankAliasesRequest) Execute() (*BankAliasesResponse, *http.Response, error) {
	return r.ApiService.ListBankAliasesExecute(r)
}

/*
ListBankAliases List the bank's aliases
...
Extra bank ids that reach this bank. Every endpoint accepts an alias wherever it accepts a bank id, so callers can be moved onto a new id in phases while the old one keeps working.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param bankId
 @return ApiListBankAliasesRequest
*/
func (a *BanksAPIService) ListBankAliases(ctx context.Context, bankId string) ApiListBankAliasesRequest {
	return ApiListBankAliasesRequest{
		ApiService: a,
		ctx: ctx,
		bankId: bankId,
...
// Execute executes the request
//  @return BankAliasesResponse
func (a *BanksAPIService) ListBankAliasesExecute(r ApiListBankAliasesRequest) (*BankAliasesResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "BanksAPIService.ListBankAliases")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
