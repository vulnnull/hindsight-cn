...
// GetLastMemoryWriteAt returns the LastMemoryWriteAt field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *BankStatsResponse) GetLastMemoryWriteAt() string {
	if o == nil || IsNil(o.LastMemoryWriteAt.Get()) {
		var ret string
		return ret
	}
	return *o.LastMemoryWriteAt.Get()
}

// GetLastMemoryWriteAtOk returns a tuple with the LastMemoryWriteAt field value if set, nil otherwise
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *BankStatsResponse) GetLastMemoryWriteAtOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return o.LastMemoryWriteAt.Get(), o.LastMemoryWriteAt.IsSet()
}

// HasLastMemoryWriteAt returns a boolean if a field has been set.
func (o *BankStatsResponse) HasLastMemoryWriteAt() bool {
	if o != nil && o.LastMemoryWriteAt.IsSet() {
		return true
	}
...
// SetLastMemoryWriteAt gets a reference to the given NullableString and assigns it to the LastMemoryWriteAt field.
func (o *BankStatsResponse) SetLastMemoryWriteAt(v string) {
	o.LastMemoryWriteAt.Set(&v)
}
// SetLastMemoryWriteAtNil sets the value for LastMemoryWriteAt to be an explicit nil
func (o *BankStatsResponse) SetLastMemoryWriteAtNil() {
	o.LastMemoryWriteAt.Set(nil)
}

// UnsetLastMemoryWriteAt ensures that no value is present for LastMemoryWriteAt, not even an explicit nil
func (o *BankStatsResponse) UnsetLastMemoryWriteAt() {
	o.LastMemoryWriteAt.Unset()
}
...
func (o BankStatsResponse) ToMap() (map[string]interface{}, error) {
	...
	if o.LastMemoryWriteAt.IsSet() {
		toSerialize["last_memory_write_at"] = o.LastMemoryWriteAt.Get()
	}
