...
// MentalModelTriggerOutput Trigger settings for a mental model.  Inherits the reflect options an operator can also default per bank (``reflect_default_options``): set here they apply to this model's refreshes only, and win over the bank default.
...
func (o *MentalModelTriggerOutput) GetReflectSearchObservationsMaxTokens() int32 {
...
func (o *MentalModelTriggerOutput) GetReflectSearchObservationsMaxTokensOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *MentalModelTriggerOutput) HasReflectSearchObservationsMaxTokens() bool {
...
func (o *MentalModelTriggerOutput) SetReflectSearchObservationsMaxTokens(v int32) {
...
func (o *MentalModelTriggerOutput) SetReflectSearchObservationsMaxTokensNil() {
...
func (o *MentalModelTriggerOutput) UnsetReflectSearchObservationsMaxTokens() {
...
func (o *MentalModelTriggerOutput) GetReflectSearchObservationsIncludeEntities() bool {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *MentalModelTriggerOutput) GetReflectSearchObservationsIncludeEntitiesOk() (*bool, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *MentalModelTriggerOutput) HasReflectSearchObservationsIncludeEntities() bool {
...
func (o *MentalModelTriggerOutput) SetReflectSearchObservationsIncludeEntities(v bool) {
...
func (o *MentalModelTriggerOutput) SetReflectSearchObservationsIncludeEntitiesNil() {
...
func (o *MentalModelTriggerOutput) UnsetReflectSearchObservationsIncludeEntities() {
...
func (o *MentalModelTriggerOutput) GetMinRefreshIntervalSeconds() int32 {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *MentalModelTriggerOutput) GetMinRefreshIntervalSecondsOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *MentalModelTriggerOutput) HasMinRefreshIntervalSeconds() bool {
...
func (o *MentalModelTriggerOutput) SetMinRefreshIntervalSeconds(v int32) {
...
func (o *MentalModelTriggerOutput) SetMinRefreshIntervalSecondsNil() {
...
func (o *MentalModelTriggerOutput) UnsetMinRefreshIntervalSeconds() {
...
func (o *MentalModelTriggerOutput) GetResponseSchema() map[string]interface{} {
	if o == nil {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *MentalModelTriggerOutput) GetResponseSchemaOk() (map[string]interface{}, bool) {
...
func (o *MentalModelTriggerOutput) HasResponseSchema() bool {
	if o != nil && !IsNil(o.ResponseSchema) {
		return true
	}
...
func (o *MentalModelTriggerOutput) SetResponseSchema(v map[string]interface{}) {
	o.ResponseSchema = v
}
