...
class TestThinkResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ThinkResponse:
        """Test ThinkResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ThinkResponse`
        """
        model = ThinkResponse()
        if include_optional:
            return ThinkResponse(
                text = '',
                based_on = [
                    {context=healthcare discussion, event_date=2024-01-15T10:30:00Z, id=123e4567-e89b-12d3-a456-426614174000, text=AI is used in healthcare, type=world}
                    ],
                new_opinions = [
                    ''
                    ]
