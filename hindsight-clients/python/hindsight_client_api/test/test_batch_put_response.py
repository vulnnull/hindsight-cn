...
class TestBatchPutResponse(unittest.TestCase):
    """BatchPutResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BatchPutResponse:
        """Test BatchPutResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BatchPutResponse`
        """
        model = BatchPutResponse()
        if include_optional:
