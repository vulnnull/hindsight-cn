...
class TestBatchPutRequest(unittest.TestCase):
    """BatchPutRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BatchPutRequest:
        """Test BatchPutRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BatchPutRequest`
        """
        model = BatchPutRequest()
        if include_optional:
            return BatchPutRequest(
                items = [
                    {content=Alice mentioned she's working on a new ML model, context=team meeting, event_date=2024-01-15T10:30:00Z}
                    ],
                document_id = ''
            )
        else:
