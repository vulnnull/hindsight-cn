...
class TestBatchPutAsyncResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> BatchPutAsyncResponse:
        """Test BatchPutAsyncResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BatchPutAsyncResponse`
        """
        model = BatchPutAsyncResponse()
        if include_optional:
    ...
    def testBatchPutAsyncResponse(self):
        """Test BatchPutAsyncResponse"""
