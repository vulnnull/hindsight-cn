    ...
    def make_instance(self, include_optional) -> SearchResponse:
        ...
        if include_optional:
            return SearchResponse(
                results = [
                    {context=work info, document_id=session_abc123, event_date=2024-01-15T10:30:00Z, id=123e4567-e89b-12d3-a456-426614174000, text=Alice works at Google on the AI team, type=world}
                    ],
                trace = { }
            )
        else:
