...
class BankTemplateConfig(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if consolidation_strategies (nullable) is None
        # and model_fields_set contains the field
        if self.consolidation_strategies is None and "consolidation_strategies" in self.model_fields_set:
            _dict['consolidation_strategies'] = None
        ...
        # set to None if knowledge_page_default_trigger (nullable) is None
        # and model_fields_set contains the field
        if self.knowledge_page_default_trigger is None and "knowledge_page_default_trigger" in self.model_fields_set:
            _dict['knowledge_page_default_trigger'] = None

        # set to None if reflect_default_options (nullable) is None
        # and model_fields_set contains the field
        if self.reflect_default_options is None and "reflect_default_options" in self.model_fields_set:
            _dict['reflect_default_options'] = None
