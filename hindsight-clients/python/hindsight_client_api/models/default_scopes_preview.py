...
class DefaultScopesPreview(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["match_count", "observation_count", "samples"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DefaultScopesPreview from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DefaultScopesPreview from a dict"""
        if obj is None:
            return None
