...
class PromptMessageModel(BaseModel):
    ...
    """ # noqa: E501
    role: StrictStr
    blocks: Optional[List[PromptBlockModel]] = None
    __properties: ClassVar[List[str]] = ["role", "blocks"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PromptMessageModel from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PromptMessageModel from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "role": obj.get("role"),
            "blocks": [PromptBlockModel.from_dict(_item) for _item in obj["blocks"]] if obj.get("blocks") is not None else None
        })
        return _obj
