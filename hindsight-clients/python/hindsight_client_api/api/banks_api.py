...
from hindsight_client_api.models.bank_aliases_response import BankAliasesResponse
...
class BanksApi:
    ...
    async def create_bank_alias(
        self,
        bank_id: StrictStr,
        create_bank_alias_request: CreateBankAliasRequest,
        authorization: Optional[StrictStr] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        Give the bank another id to answer to. Nothing is copied or moved: the bank keeps its own id and all of its data, and the alias is only a second way to reach it — which is what makes it a zero-downtime alternative to renaming.  Returns 409 if the name is already a bank or another alias.

        :param bank_id: (required)
        :type bank_id: str
        :param create_bank_alias_request: (required)
        :type create_bank_alias_request: CreateBankAliasRequest
        :param authorization:
        :type authorization: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
        ...
        _param = self._create_bank_alias_serialize(
            bank_id=bank_id,
            create_bank_alias_request=create_bank_alias_request,
            authorization=authorization,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    async def create_bank_alias_with_http_info(
        self,
        bank_id: StrictStr,
        create_bank_alias_request: CreateBankAliasRequest,
        authorization: Optional[StrictStr] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[BankAliasesResponse]:
        """Add an alias to the bank
    ...
    @validate_call
    async def create_bank_alias_without_preload_content(
        self,
        bank_id: StrictStr,
        create_bank_alias_request: CreateBankAliasRequest,
        authorization: Optional[StrictStr] = None,
    ...
    def _create_bank_alias_serialize(
        self,
        bank_id,
        create_bank_alias_request,
        authorization,
        _request_auth,
        _content_type,
        _headers,
        ...
        # process the form parameters
        # process the body parameter
        if create_bank_alias_request is not None:
            _body_params = create_bank_alias_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/default/banks/{bank_id}/aliases',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    async def delete_bank_alias(
        ...
        _param = self._delete_bank_alias_serialize(
            bank_id=bank_id,
            alias=alias,
            authorization=authorization,
            _request_auth=_request_auth,
    ...
    @validate_call
    async def delete_bank_alias_with_http_info(
        self,
        bank_id: StrictStr,
        alias: StrictStr,
        authorization: Optional[StrictStr] = None,
    ...
    @validate_call
    async def delete_bank_alias_without_preload_content(
        self,
        bank_id: StrictStr,
        alias: StrictStr,
        authorization: Optional[StrictStr] = None,
    ...
    def _delete_bank_alias_serialize(
        self,
        bank_id,
        alias,
        authorization,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/v1/default/banks/{bank_id}/aliases/{alias}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    async def list_bank_aliases(
        ...
        _param = self._list_bank_aliases_serialize(
            bank_id=bank_id,
            authorization=authorization,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    async def list_bank_aliases_with_http_info(
        self,
        bank_id: StrictStr,
        authorization: Optional[StrictStr] = None,
        _request_timeout: Union[
    ...
    @validate_call
    async def list_bank_aliases_without_preload_content(
        self,
        bank_id: StrictStr,
        authorization: Optional[StrictStr] = None,
        _request_timeout: Union[
    ...
    def _list_bank_aliases_serialize(
        self,
        bank_id,
        authorization,
        _request_auth,
    ...
    async def set_bank_alias_primary(
        ...
        bank_id: StrictStr,
        alias: StrictStr,
        set_bank_alias_primary_request: SetBankAliasPrimaryRequest,
        authorization: Optional[StrictStr] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        Present the bank under one of its aliases. Purely cosmetic: the bank keeps its own `bank_id`, which every other part of the system — authorisation, metering, exports, audit logs — continues to use.  Promoting an alias demotes whichever one was shown before, so a bank is presented under at most one alias. Send `primary: false` to go back to showing its own id.

        :param bank_id: (required)
        :type bank_id: str
        :param alias: (required)
        :type alias: str
        :param set_bank_alias_primary_request: (required)
        :type set_bank_alias_primary_request: SetBankAliasPrimaryRequest
        :param authorization:
        :type authorization: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
        ...
        _param = self._set_bank_alias_primary_serialize(
            bank_id=bank_id,
            alias=alias,
            set_bank_alias_primary_request=set_bank_alias_primary_request,
            authorization=authorization,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    async def set_bank_alias_primary_with_http_info(
        self,
        bank_id: StrictStr,
        alias: StrictStr,
        set_bank_alias_primary_request: SetBankAliasPrimaryRequest,
    ...
    @validate_call
    async def set_bank_alias_primary_without_preload_content(
        self,
        bank_id: StrictStr,
        alias: StrictStr,
        set_bank_alias_primary_request: SetBankAliasPrimaryRequest,
    ...
    def _set_bank_alias_primary_serialize(
        self,
        bank_id,
        alias,
        set_bank_alias_primary_request,
        authorization,
        _request_auth,
        _content_type,
        _headers,
        ...
        # process the form parameters
        # process the body parameter
        if set_bank_alias_primary_request is not None:
            _body_params = set_bank_alias_primary_request
